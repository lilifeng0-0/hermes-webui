...
const LOCALES = {
  ...
  untitled:'Untitled',
    ...
    // models tab
    models_add_provider: '+ Add Provider',
    models_no_providers: 'No providers configured.',
    models_loading: 'Loading...',
    models_add_form_title: 'Add Custom Provider',
    models_form_name: 'Provider Name',
    models_form_base_url: 'Base URL',
    models_form_api_key: 'API Key',
    models_fetch_btn: 'Fetch Models',
    models_fetching: 'Fetching models...',
    models_fetched_n: (n) => `Found ${n} models`,
    models_fetch_error: 'Fetch failed',
    models_save_btn: 'Save Provider',
    // channels/proxy tab
    channels_proxy_enable: 'Enable Proxy',
    channels_proxy_enable_hint: 'Route API requests through a custom proxy endpoint.',
    channels_proxy_base_url: 'Proxy Base URL',
    channels_proxy_api_key: 'Proxy API Key',
    // usage tab
    usage_total_tokens: 'Total Tokens',
    usage_total_sessions: 'Total Sessions',
    usage_input_tokens: 'Input Tokens',
    usage_output_tokens: 'Output Tokens',
    usage_cache_tokens: 'Cache Tokens',
    usage_cost: 'Est. Cost',
    usage_by_model: 'By Model',
    usage_daily_trend: 'Daily Trend (30d)',
    ...
    new_skill: 'New skill',
    upload_skill: '上传skill',
    upload_skill_hint: '拖拽 .zip 或 .skill 文件到此处，或点击选择文件',
    upload_skill_invalid_format: '只支持 .zip 或 .skill 格式',
    upload_skill_timeout: '上传超时，请重试',
    upload_skill_success: 'Skill 上传成功',
